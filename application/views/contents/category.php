...
<div class="alert" style="text-align: center; color: white; position:fixed;top:50%;left:50%;width:500px;height:50px;margin-left:-250px;margin-top:-25px;opacity: 0.7; background-color: gray;display: none;"></div>
  ...
  <script>
    ...
    $(".type").on('click', function(){
      ...
      $("#profile").load("http://localhost/rstl_pm/tourismfarmcategory/oneCategory");
    });
    ...
    $(".savenewcat").on('click',function(){
      ...
      if (catname == ""){
        ...
        console.log(catname);
        $.ajax({
          url: "http://localhost/rstl_pm/tourismfarmcategory/addNewCategory",
          type: "POST",
          data: {"data":catname},
          success: function(data){
            console.log(data);
            $("#myCatModal").modal('hide');
            $("#reloadDiv").load("http://localhost/rstl_pm/tourismfarmcategory/tourCateg");
